...
# set a7 +incdir+../../src/testbench/sdr_sdram/*.v
# set a8 ../../src/testbench/*.v
set a8 ../../src/testbench/test_ahb_lite.v

vlog $a0 $a1 $a2 $a3 $a4 $a5 $a6  $a8 
#  $a7

vsim work.test_ahb_lite
add wave -radix hex sim:/test_ahb_lite/*
run -all
wave zoom full